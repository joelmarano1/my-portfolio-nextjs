...
const TechStack = () => {  
  ...
  return (
    <section className="grid lg:grid-cols-12  pt-[100px] lg:pt-[0px]  grid-cols-1 gap-10 lg:gap-16 xl:gap-10 lg:px-4 pb-32">
      <div className="lg:col-span-12">
        <MotionDiv
            ...
            whileInView="visible"
            >
            <h1 className="text-xs lg:text-md text-white dark:text-[#2C3F50] lg:pl-1">SKILLS</h1>
            <h1 className="text-2xl md:text-5xl vio-text font-extrabold"><span className="text-white  dark:text-[#2C3F50]">My Tech</span>Stack</h1>
        </MotionDiv>
      </div>
      <div className="lg:col-span-6 rounded-lg h-full ">
        <MotionDiv 
            ...
            <h1 className="text-2xl md:text-3xl font-semibold text-white  dark:text-[#2C3F50]"><span className="underline underline-offset-8 decoration-[#9340FF]">Front</span>end </h1>
            <div className=" mt-5 text-slate-300  dark:text-[#2C3F50] text-center grid grid-cols-4 lg:grid-cols-6 gap-5 lg:gap-10 text-xs ">
      ...
      <div  className="lg:col-span-6 rounded-lg h-full ">
        <MotionDiv 
            ...
            whileInView="visible"
        >
            <h1 className="text-2xl md:text-3xl font-semibold text-white  dark:text-[#2C3F50]"><span className="underline underline-offset-8 decoration-[#9340FF]">Back</span>end </h1>
            <div className=" mt-5 text-slate-300  dark:text-[#2C3F50] text-center grid grid-cols-4 lg:grid-cols-6 gap-5 lg:gap-10 text-xs ">
