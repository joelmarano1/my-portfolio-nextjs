      ...
      <MotionDiv 
        ...
        <div className="grid lg:grid-cols-9 grid-cols-6">
          <div className="lg:col-span-1 col-span-1">
            <div className="flex flex-col justify-items-center pt-14 gap-10 text-2xl text-white dark:text-[#2C3F50]">
          ...
          <div className="lg:col-span-8 col-span-5">
            <div className=" mb-[50px] lg:mb-0 text-white">
              <div className="flex items-center">
                  <span className="text-md sm:text-3xl pl-1 font-medium text-white dark:text-[#2C3F50]"> Hello, I'm </span>
